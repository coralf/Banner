...
public class Banner extends FrameLayout {
    ...
    //小圆点选中状态下颜色
    private static final String POINTER_CURRENT_COLOR_DEF = "#DDDDDD";
    //小圆点没有选中下颜色
    private static final String POINTER_COLOR_DEF = "#CC0000";
    ...
    public Banner(@NonNull Context context, List<View> itemViews) {
        super(context);
        this.context = context;
    ...
    private void initPointer() {
        ...
        int index = currentPosition % (itemViews.size());
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            int index = position % itemViews.size();
